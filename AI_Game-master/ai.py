...
def bfs(start):
    ...
    while queue:
        ...
        if state.state in visited: continue
...
def ucs(start):
    ...
    while pq:
        ...
        if state.state in visited and visited[state.state] <= cost: continue
...
def astar(start):
    ...
    while pq:
        ...
        if state.state in visited and visited[state.state] <= g: continue
